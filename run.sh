...
export PROGRESS_WINDOW_METERS="$(bashio::config 'progress_window_meters')"
export LATERAL_OFFSET_LIMIT_METERS="$(bashio::config 'lateral_offset_limit_meters')"
export BACKTRACK_TOLERANCE_METERS="$(bashio::config 'backtrack_tolerance_meters')"
export AMBIGUOUS_SEGMENT_EPSILON_METERS="$(bashio::config 'ambiguous_segment_epsilon_meters')"
